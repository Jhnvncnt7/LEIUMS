...
get_ans1:
    ...
    while (1) {
        ...
        if (ch == 0 || ch == 224) {
            ...
            else if (ch == 77 && page < totalPages - 1) { page++; selected = 0; }  // next
            else if (ch == 75 && page > 0) { page--; selected = 0; }               // prev
            else if (ch == 83) { // DEL
...
get_status: // ===== STATUS =====
    ...
    gotoxy(1,10); clreol(); cout << "Computed Efficiency    : " << eq.efficiency << "%";
    gotoxy(1,11); clreol(); cout << "Computed Availability  : " << eq.availabilityRate << "%";
